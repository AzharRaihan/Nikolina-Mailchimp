    ...
    <section class="game-page">
        <div class="container">
                ...
                <div class="row ">
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="{{ asset('assets/frontend/img/games-categories/cats-trophy.png') }}" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
                                <div class="games-content-head" style="color: #FF119B;">Cat's Trophy</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-6 col-xl-6 pt-5">
                        <div class="games-icon text-center">
                            <img src="{{ asset('assets/frontend/img/games-categories/jolly-jam.png') }}" alt="games3" class="img-fluid">
                        </div>
                        <a href="#">
                            <div class="games-body">
                                <div class="games-content-head" style="color: #FF119B;">Jolly Jam</div>
                                <div class="platform-wrap">
                                    <h3><strong>Platform :</strong></h3>
                                    <div class="platform-icon">
                                        <i class="fab fa-apple"></i>
            ...
            <ul class="pagination justify-content-end pb-3">
                <li class="page-item"><a class="page-link" href="{{ route('games2') }}">Previous</a></li>
